...
# Memory: onchip_memory_1
MEM_0 := soc_system_onchip_memory_1
$(MEM_0)_NAME := onchip_memory_1
...
$(MEM_0)_START := 0x08004000
$(MEM_0)_END := 0x08007fff
$(MEM_0)_SPAN := 0x00004000
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory_1
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory_1
onchip_memory_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: sdram_controller_2
MEM_1 := sdram_controller_2
$(MEM_1)_NAME := sdram_controller_2
...
$(MEM_1)_HIERARCHICAL_PATH := sdram_controller_2
$(MEM_1)_WIDTH := 16
$(MEM_1)_HEX_DATA_WIDTH := 16
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: sdram_controller_2
sdram_controller_2: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

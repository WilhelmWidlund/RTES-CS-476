...
(
    ...
    localparam PAD4 = log2ceil(64'h8041040 - 64'h8041020); 
    localparam PAD5 = log2ceil(64'h8041060 - 64'h8041040); 
    localparam PAD6 = log2ceil(64'h8041080 - 64'h8041060); 
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h8041098;
    ...
    // ( 0x8041060 .. 0x8041080 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 28'h8041060   ) begin
    ...
    // ( 0x8041090 .. 0x8041098 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 28'h8041090   ) begin

...
add_interface_port avalon_slave_0_1 AS_Addr address Input 2
add_interface_port avalon_slave_0_1 AS_Wr write Input 1
add_interface_port avalon_slave_0_1 AS_WData writedata Input 32
...
add_interface_port conduit_end DEBUG readdata Output 8

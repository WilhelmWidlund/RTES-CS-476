...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../multiprocessor_tutorial.jdi
...
# CPU Name 
# setting CPU_NAME is philosopher_three_cpu_three
CPU_NAME = philosopher_three_cpu_three
...
# Design Name 
# setting SOPC_NAME is multiprocessor_tutorial_main_system
SOPC_NAME := multiprocessor_tutorial_main_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4060b00
SOPC_SYSID_FLAG += --sidp=0x4060b00
ELF_PATCH_FLAG  += --sidp 0x4060b00

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1305946145
SOPC_SYSID_FLAG += --timestamp=1305946145
ELF_PATCH_FLAG  += --timestamp 1305946145
...
# setting hal.stderr is philosopher_three_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev philosopher_three_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is philosopher_three_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev philosopher_three_jtag_uart
...
# setting hal.stdout is philosopher_three_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev philosopher_three_jtag_uart

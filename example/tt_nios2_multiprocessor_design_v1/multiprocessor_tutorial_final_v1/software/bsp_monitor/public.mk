...
# setting SOPC_SYSID_BASE_ADDRESS is 0x60b00
SOPC_SYSID_FLAG += --sidp=0x60b00
ELF_PATCH_FLAG  += --sidp 0x60b00
...
# setting hal.stderr is jtag_uart_top
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_top

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_top
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_top
...
# setting hal.stdout is jtag_uart_top
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_top

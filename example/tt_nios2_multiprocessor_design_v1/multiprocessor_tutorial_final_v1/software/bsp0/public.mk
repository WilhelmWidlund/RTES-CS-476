...
# CPU Name 
# setting CPU_NAME is philosopher_zero_cpu_zero
CPU_NAME = philosopher_zero_cpu_zero
...
# setting hal.stderr is philosopher_zero_jtag_uart
ELF_PATCH_FLAG  += --stderr_dev philosopher_zero_jtag_uart

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is philosopher_zero_jtag_uart
ELF_PATCH_FLAG  += --stdin_dev philosopher_zero_jtag_uart
...
# setting hal.stdout is philosopher_zero_jtag_uart
ELF_PATCH_FLAG  += --stdout_dev philosopher_zero_jtag_uart

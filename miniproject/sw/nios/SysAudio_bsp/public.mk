...
# CPU Name 
# setting CPU_NAME is SysAudio_NIOS_II
CPU_NAME = SysAudio_NIOS_II
...
# setting hal.stderr is SysAudio_JTAG_UART
ELF_PATCH_FLAG  += --stderr_dev SysAudio_JTAG_UART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is SysAudio_JTAG_UART
ELF_PATCH_FLAG  += --stdin_dev SysAudio_JTAG_UART
...
# setting hal.stdout is SysAudio_JTAG_UART
ELF_PATCH_FLAG  += --stdout_dev SysAudio_JTAG_UART

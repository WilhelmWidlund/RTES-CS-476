...
# Memory: SysAudio_Onchip_Memory
MEM_1 := soc_system_SysAudio_Onchip_Memory
$(MEM_1)_NAME := SysAudio_Onchip_Memory
...
$(MEM_1)_HIERARCHICAL_PATH := SysAudio_Onchip_Memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: SysAudio_Onchip_Memory
SysAudio_Onchip_Memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

...
SOPCINFO_FILE := C:/RTES/miniproject/hw/quartus/soc_system.sopcinfo
...
# CPU Name 
# setting CPU_NAME is SysSigProc_NIOS_II
CPU_NAME = SysSigProc_NIOS_II
...
# setting hal.stderr is SysSigProc_JTAG_UART
ELF_PATCH_FLAG  += --stderr_dev SysSigProc_JTAG_UART

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is SysSigProc_JTAG_UART
ELF_PATCH_FLAG  += --stdin_dev SysSigProc_JTAG_UART
...
# setting hal.stdout is SysSigProc_JTAG_UART
ELF_PATCH_FLAG  += --stdout_dev SysSigProc_JTAG_UART

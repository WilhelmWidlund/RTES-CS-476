...
# Memory: SDRAM_Controller_Shared
MEM_0 := SDRAM_Controller_Shared
$(MEM_0)_NAME := SDRAM_Controller_Shared
...
$(MEM_0)_HIERARCHICAL_PATH := SDRAM_Controller_Shared
$(MEM_0)_WIDTH := 16
$(MEM_0)_HEX_DATA_WIDTH := 16
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: SDRAM_Controller_Shared
SDRAM_Controller_Shared: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: SysSigProc_Onchip_Memory
MEM_1 := soc_system_SysSigProc_Onchip_Memory
$(MEM_1)_NAME := SysSigProc_Onchip_Memory
...
$(MEM_1)_START := 0x04040000
$(MEM_1)_END := 0x0406a7ff
$(MEM_1)_SPAN := 0x0002a800
$(MEM_1)_HIERARCHICAL_PATH := SysSigProc_Onchip_Memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: SysSigProc_Onchip_Memory
SysSigProc_Onchip_Memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
